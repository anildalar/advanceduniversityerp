...
<head>
	...
	<!-- data tables -->
	<link href="<?php echo base_url('assets/backend/'); ?>plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.css" rel="stylesheet"
		type="text/css" />
...
<body
																...
																<tbody>
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std1.jpg"
																				alt="">
																		</td>
																		<td class="left">18</td>
																		<td>Rajesh Bhatt</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std10.jpg"
																				alt="">
																		</td>
																		<td class="left">5</td>
																		<td>Pooja Patel</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std2.jpg"
																				alt="">
																		</td>
																		<td class="left">15</td>
																		<td>Sarah Smith</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std3.jpg"
																				alt="">
																		</td>
																		<td class="left">23</td>
																		<td>John Deo</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std4.jpg"
																				alt="">
																		</td>
																		<td class="left">10</td>
																		<td>Jay Soni</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std5.jpg"
																				alt="">
																		</td>
																		<td class="left">14</td>
																		<td>Jacob Ryan</td>
																	...
																	<tr class="odd gradeX">
																		<td class="patient-img">
																			<img src="<?php echo base_url('assets/backend/'); ?>img/std/std6.jpg"
																				alt="">
																		</td>
																		<td class="left">7</td>
																		<td>Megha Trivedi</td>
										...
										<div class="row">
												...
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std10.jpg" class="doctor-pic"
																alt="">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std1.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std2.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std3.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std4.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
											...
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std5.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
										...
										<div class="row">
											<div class="col-md-4">
												<div class="card card-box">
													<div class="card-body no-padding ">
														<div class="doctor-profile">
															<img src="<?php echo base_url('assets/backend/'); ?>img/std/std6.jpg" class="doctor-pic"
																alt="">
															<div class="profile-usertitle">
	...
	<script src="<?php echo base_url('assets/backend/'); ?>js/pages/table/table_data.js"></script>
	<!-- Common js-->
