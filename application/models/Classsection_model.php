...
class Classsection_model extends MY_Model {
	...
	public function getClassSectionBySchoolId(){
		$this->db->select('class_sections.id,class_sections.section_id,sections.section,class_sections.class_id,classes.class');
		$this->db->from('class_sections');
		$this->db->join('sections', 'sections.id = class_sections.section_id');
    ...
    public function getByID($id = null) {
		...
		if ($id != null) {
			...
			$this->db->where('classes.school_id', $this->school_id);
	...
	public function getVechileByRoute($id) {
		...
		$this->db->where(array('class_sections.class_id'=>$id,'class_sections.school_id'=> $this->school_id));
