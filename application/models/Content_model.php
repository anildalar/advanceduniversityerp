...
class Content_model extends MY_Model {
    ...
    public function get($id = null) {
        ...
        $this->db->limit(10);
		$this->db->where('contents.school_id',$this->school_id);
        $query = $this->db->get();
        if ($id != null) {
    ...
    public function getListByCategoryforUser($class_id, $category) {
        $query = "SELECT * FROM `contents` WHERE ((class_id =$class_id and type='$category') or (is_public='yes' and type='$category')) and contents.school_id=".$this->school_id;
