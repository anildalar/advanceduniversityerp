...
class Book_model extends MY_Model {
    ...
    public function get($id = null) {        
		...
		$this->db->where('books.school_id', $this->school_id);
        $query = $this->db->get();
        if ($id != null) {
    ...
    public function getTypeByFeecategory($type, $class_id) {
        $this->db->select('feemasters.id,feemasters.school_id,feemasters.session_id,feemasters.amount,feemasters.description,classes.class,feetype.type')->from('feemasters');
