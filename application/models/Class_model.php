...
class Class_model extends MY_Model {
	...
	*/
    ...
    public function remove($id) {
		$this->db->trans_begin();
		$this->db->where(array('id'=> $id,'school_id'=>$this->school_id));
		$this->db->delete('classes');//class record delete.

		$this->db->where(array('class_id'=>$id,'school_id'=>$this->school_id));
    ...
    function check_data_exists($data) {
		$this->db->where(array('class'=> $data,'school_id'=>$this->school_id));
