  ...
  /**
   ...
   public function add($data) {
    ...
    function book_issuedByMemberID($member_id){
		$this->db->select('book_issues.school_id,book_issues.return_date,books.book_no,book_issues.issue_date,book_issues.is_returned,books.book_title,books.author')
			->from('book_issues')
