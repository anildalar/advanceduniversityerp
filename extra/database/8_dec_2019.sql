...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2019 at 12:26 PM
...
CREATE TABLE `colleges` (
  ...
  `location_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'rural,urban'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `colleges` (`college_id`, `college_name`, `college_addr`, `created_at`, `college_types`, `location_type`) VALUES
(1, 'Balkavi Bairagi Mahavidhalya', 'Neemuch', '2019-11-19 09:03:59', 'GOVT', 'RURAL'),
(2, 'PG College', 'Neemuch', '2019-11-19 09:54:46', 'PRIVATE', 'URBAN'),
(3, 'Saint Peter College', 'New York', '2019-12-04 06:30:16', 'GOVT', 'NA');
...
--
-- Table structure for table `college_seats`
--
...
CREATE TABLE `college_seats` (
  ...
  `course_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `seat_alloted` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `university_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `college_universities`
--
...
--
-- Dumping data for table `college_universities`
--

INSERT INTO `college_universities` (`id`, `college_id`, `university_id`) VALUES
(1, '1', '1'),
(2, '2', '1');
...
(2, 'Surendra Panday Sir', 'Proffessor', '2019-11-01', '2019-11-21 09:38:38', '', '2');
...
--
-- Table structure for table `grade_system_type`
--
...
--
-- Dumping data for table `grade_system_type`
--

INSERT INTO `grade_system_type` (`id`, `name`, `descripiton`, `university_id`) VALUES
(1, 'Grading System', '', '1'),
(2, 'Non Grading System', '', '1'),
(3, 'CBCS', 'Choice Based Credit System', '1'),
(4, 'CBGS', 'Credit Based Grading System', '1'),
(5, 'As per COA', '', '1');
...
CREATE TABLE `jobs` (
  ...
  `pdf_addr` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `university_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `jobs` (`id`, `job_no`, `job_title`, `job_description`, `last_date`, `pdf_addr`, `university_id`) VALUES
(1, '71719 ', 'Advertisement for the purely temporary positions on contractual appointment basis for Project staff under e-Governance project of UGC at New Delhi', 'Advertisement for the purely temporary positions on contractual appointment basis for Project staff under e-Governance project of UGC at New Delhi', '0000-00-00', '', '6');
...
INSERT INTO `news` (`id`, `news_title`, `news_description`, `created_at`, `university_id`) VALUES
(1, 'LATINOO COLLEGE EXPO 2020', 'Nulla at velit convallis, venen Nulla at velit convallis, venenNulla at velit convallis, venenNulla at velit convallis, venenNulla at velit convallis, venenNulla at velit convallis, venenNulla at velit convallis, venen', '2019-11-29 13:53:47', '1'),
(2, 'TRAINING AT TEAM FABIO ', 'Nulla at velit convallis veNulla at velit convalNulla at velit convallis venenatilis venenatinenatiNulla at velit convallis venenatiNulla at velit convallis venenati', '2019-11-29 13:59:25', '1');
...
INSERT INTO `students` (`student_id`, `student_name`, `student_lname`, `student_mobno`, `stu_enroll_no`, `university_id`) VALUES
(1, 'Shreepal', 'Meghwal', '9879798798', 'EN123456789', '1'),
(2, 'Anmol', 'Bairagi', '97987987987', 'EN12341234', '2');
...
INSERT INTO `subjects` (`id`, `name`, `code`, `type`, `descripiton`, `is_active`, `created_at`, `updated_at`) VALUES
(1, 'INFORMATION & COMMUNICATION TECHNOLOGY', '8016', 'TH', '', 'yes', '2019-11-29 09:26:20', '0000-00-00 00:00:00'),
(2, 'OPERATING SYSTEM', '8017', 'TH', '', 'yes', '2019-11-29 09:26:25', '0000-00-00 00:00:00'),
(3, 'PROGRAMMING WITH C', '8018', 'TH,PR', '', 'yes', '2019-11-29 09:26:09', '0000-00-00 00:00:00'),
(4, 'PC PACKAGES', '8019', 'TH,PR', '', 'yes', '2019-11-29 09:26:02', '0000-00-00 00:00:00'),
(5, 'COMMUNICATIVE ENGLISH', '8020', 'TH', '', 'yes', '2019-11-29 09:26:31', '0000-00-00 00:00:00'),
(6, 'Introduction to Computer Science', 'CSC148H5Y', 'TH', 'Abstract data types and data structures for implementing them. Linked data structures. Encapsulation and information-hiding. Object-oriented programming. Specifications. Analyzing the efficiency of programs. Recursion. This course assumes programming experience in a language such as Python, C++, or Java, as provided by CSC108H5. Students who already have this background may consult the Computer Science faculty advisor for advice about skipping CSC108H5. [36L, 24P]', 'no', '2019-11-29 09:32:23', '0000-00-00 00:00:00');
...
CREATE TABLE `universities` (
  ...
  `subdomain` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'www',
  `belongs_to` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Belongs To University Controller',
  `university_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `university_slogan` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `university_address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `university_state_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `university_contact` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `university_theme` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_of_established` date NOT NULL,
  `show_alertbox` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1' COMMENT '0=no,1=yes',
  `show_marquee` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `show_hitcounter` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `social_fb` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `social_tw` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `social_gp` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `social_linkden` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `social_youtube` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `universities` (`id`, `domain_name`, `domain_type`, `subdomain`, `belongs_to`, `university_name`, `university_slogan`, `university_address`, `country_id`, `university_state_id`, `university_contact`, `university_email`, `university_types`, `university_logo`, `university_theme`, `date_of_established`, `show_alertbox`, `show_marquee`, `show_hitcounter`, `social_fb`, `social_tw`, `social_gp`, `social_linkden`, `social_youtube`, `is_active`, `created_at`, `licence_expire_at`) VALUES
(1, 'vikramuniv.ac.in', 'university', 'www,alumni,placement', '6', 'Vikram University', 'Vidhaya Mritam Shrute', 'University Road, Madhav Bhavan, Near Vikram Vatika, Ujjain, Madhya Pradesh 10000 INDIA', '99', '', '+101-1231-77777', 'vikramuniversity@gmail.com', '1', 'vikram.jpg', 'theme6', '1988-01-01', '0', '1', '0', '', '', '', '', '', '1', '2019-11-19 14:31:03', '2020-12-01'),
(2, 'bitmesra.ac.in', 'university', 'purchase,placement', '6', 'Birla Institute of Technology', '', 'Mesra', '99', '', '', 'bitmesra@gmail.com', '2', '', 'theme1', '0000-00-00', '', '1', '0', '', '', '', '', '', '1', '2019-11-21 14:46:12', '0000-00-00'),
(3, 'smu.edu.in', 'university', 'www', '6', 'Sikkim Manipal University', '', 'Sikkim', '99', '', '', 'smu@gmail.com', '1', '', 'theme1', '0000-00-00', '', '1', '0', '', '', '', '', '', '1', '2019-11-21 14:47:51', '0000-00-00'),
(4, 'du.ac.in', 'university', 'www', '6', 'Delhi University', '', 'Delhi', '99', '', '', 'du.ac.in@gmail.com', '1', '', 'theme3', '2019-11-01', '', '1', '0', '', '', '', '', '', '1', '2019-11-28 11:43:53', '0000-00-00'),
(5, 'rgpv.ac.in', 'university', 'www', '6', 'RGPV', '', 'BHOPAL', '99', '', '', '', '1', '', 'theme1', '0000-00-00', '', '1', '0', '', '', '', '', '', '1', '2019-11-29 15:11:03', '0000-00-00'),
(6, 'ugc.ac.in', 'universitycontroller', 'www', '', 'UGC', 'Quality Higher Eduction for All', 'Delhi', '99', '', '', 'info@ugc.ac.in', '1', '', 'uc_theme1', '0000-00-00', '1', '1', '1', '', '', '', '', '', '1', '2019-12-07 14:35:50', '0000-00-00');

-- --------------------------------------------------------

--
-- Table structure for table `university_affiliations`
--

CREATE TABLE `university_affiliations` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'University Affiliation applicable for country id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `university_affiliations`
--

INSERT INTO `university_affiliations` (`id`, `name`, `country_id`) VALUES
(1, 'UGC', '99'),
(2, 'NAICU', '226'),
(3, 'AICUM', '226'),
(4, 'AAU', '226'),
...
--
-- Indexes for table `college_seats`
--
ALTER TABLE `college_seats`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `college_universities`
--
ALTER TABLE `college_universities`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `grade_system_type`
--
ALTER TABLE `grade_system_type`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `university_affiliations`
--
ALTER TABLE `university_affiliations`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `college_seats`
--
ALTER TABLE `college_seats`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `college_universities`
--
ALTER TABLE `college_universities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `grade_system_type`
--
ALTER TABLE `grade_system_type`
...
--
-- AUTO_INCREMENT for table `university_affiliations`
--
ALTER TABLE `university_affiliations`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
